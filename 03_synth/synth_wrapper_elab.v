...
// Generated on: May 19 2025 01:53:02
...
module synth_wrapper(clk, rst_n, a, b, op, result, carry);
  ...
  case_box ctl_op_79_13(.in_0 (op), .out_0 ({n_34, n_35, n_36, n_37,
       n_38, n_39, n_40, n_41}));
  mux mux_carry_reg_79_13(.ctl ({n_34, n_35, n_36, n_37, n_38, n_39,
  ...
  mux_11 mux_carry_reg_79_5(.ctl ({n_44, n_45, n_46}), .in_0
       (add_carry), .in_1 (sub_carry), .in_2 (n_47), .z (n_48));
  bmux_12 mux_carry_reg_72_9(.ctl (n_30), .in_0 (n_48), .in_1 (1'b0),
       .z (UNCONNECTED));
  mux_13 mux_result_reg_79_13(.ctl ({n_34, n_35, n_36, n_37, n_38,
  ...
  bmux mux_result_reg_72_9(.ctl (n_30), .in_0 ({n_52, n_51, n_50,
